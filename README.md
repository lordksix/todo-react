...
**To Do App** is React-based App to create a To Do List. This application lets us add to-dos, edit, and delete items. Log in to see the delete feature. It also persists to-dos in the browser's local storage for a subsequent visit.
...
```sh
  ...
  git clone git@github.com:lordksix/todo-react.git
```
...
I would like to thank Ibas Majeed for this project.
